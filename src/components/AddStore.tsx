    ...
    return (
        <div className={styles['add-store']}>
            ...
            <div className={styles['add-store-front']}>
                <input className={styles.input} onChange={setNewStoreTitleHandler} type="text" value={newStoreTitle} placeholder='הוסף מקום' />
                ...
                <button className={styles.button} onClick={addStoreHandler}>+</button>
            </div>
        </div>
